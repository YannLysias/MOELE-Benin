                ...
                <div class="col-lg-5 col-md-8 col-14 mx-auto">
                    <div class="card px-4 flex gap-4 py-5">
                        <div class=" d-flex flex-column align-items-center">
                            <img src="assets/img/Logo MOELE.jpg" width="120px" alt="" class="img-fluid">
                            <h5 class="card-title text-primary pt-2 fs-5 fw-bold">Connexion</h5>
