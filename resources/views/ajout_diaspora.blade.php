          ...
          @csrf
              ...
              <div class="row">
                <div class="col-md-6 form-group mt-3">
                  ...
                  <input class="form-control" name="lieu_naissance" class='lieu_naissance' placeholder="Pas obligatoire" required="required" type="text"  value="{{ old('lieu_naissance') }}"/>
                  @error('lieu_naissance')
                  <div class="d-block text-danger">{{$message}}</div>
                  @enderror
                </div>
                <div class="col-md-6 form-group mt-3">
                  <label for="prenom" class="form-label"><b>Pays actuel*</b></label>
