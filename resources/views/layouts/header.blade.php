...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo me-auto"><img src="/assets/img/Logo MOELE.jpg" alt="" class="img-fluid"><a href="#" style="color: #092390;">MOELE-BENIN</a></h1>
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
             <ul class="">
                ...
                {{-- <li><a href="#" style="color: #092390;">A PROPOS</a></li> --}}
                <li class="nav-item me-lg-5">
        ...
        <a href="{{ route('login') }}" class="get-started-btn" style="background-color: #092390; color: #fff;">SE
            CONNECTER</a>
