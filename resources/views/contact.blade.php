...
<body>
  ...
  <main id="main">
    ...
    <!-- ======= Breadcrumbs ======= -->
    <div class="breadcrumbs" style="background-color: #092390;">
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Adresse:</h4>06 BP : 1117 Cotonou, 5ème arrondissement RB
                <p> </p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4> moelelebenin01@gmail.com
              </div>

              <div class="phone">
                <i class="bi bi-phone"></i>
                <h4>Téléphone</h4> 00229 01 99 272 828
                <p> </p>
              </div>
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="#" method="post" role="form" class="php-email-form">
              ...
              <div class="text-center"><button type="submit" style="background-color: #092390;">Soumettre</button></div>
            </form>
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center" style="background-color: #092390;"><i
