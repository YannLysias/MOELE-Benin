...
<div class="right_col" role="main">
    ...
    <form id="formulaire" action="/coordonateur" method="post" enctype="multipart/form-data" novalidate>
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Prénom(s)*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Date Naissance*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Lieu de Naissance*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            ...
            <label class="col-form-label col-md-3 col-sm-3 label-align">Departements*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Circonscription*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Communes*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Arrondissements*</label>
            <div class="col-md-6 col-sm-6">
        ...
        <div class="field item form-group">
            <label class="col-form-label col-md-3 col-sm-3  label-align">Quartiers</label>
            <div class="col-md-6 col-sm-6">
